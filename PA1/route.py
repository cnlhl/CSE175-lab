...
class Node:
    ...
    def expand(self, problem):
        ...
        from this node."""
        # print('expand node ',self.loc,' with path value ',self.value(sort_by='g'),' heuristic value',self.value(sort_by='h'))
...
class Frontier:
    ...
    def add(self, nodes):
        ...
        if isinstance(nodes, list):
            ...
            # print('add node', nodes.loc,'with value',nodes.value(self.sort_by))
